...
# Define a NamedTuple to hold hyperparameters
HParams = namedtuple('HParams', [
    'epochs', 'iters_per_checkpoint', 'seed', 'dynamic_loss_scaling', 'fp16_run', 'distributed_run', 
    ...
    'postnet_embedding_dim', 'postnet_kernel_size', 'postnet_n_convolutions', 'use_saved_learning_rate', 
    'learning_rate', 'weight_decay', 'grad_clip_thresh', 'batch_size', 'mask_padding'
])
